...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            input_fea_train_arr = preprocessing_obj.fit_transform(input_feature_train_df)
            input_fea_test_arr = preprocessing_obj.transform(input_feature_test_df)

            train_arr = np.c_[
                input_fea_train_arr, np.array(target_feature_train_df)
            ] 
            test_arr = np.c_[
                input_fea_test_arr, np.array(target_feature_test_df)
            ]
            
            logging.info("Saving preprocessing data.")
